...
import {
  deliverySchema,
  DeliverySchema,
} from "@/lib/Roles/Delivery/deliverySchema";
  ...
  async function onSubmit(values: z.infer<typeof deliverySchema>) {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your application to become a Delivery Partner has been submitted for review.",
      });
        ...
        <div className="lg:w-1/3 space-y-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Join our platform as a delivery partner and help deliver sacred
              items to devotees at their doorstep.
            </p>
          </div>
              ...
              <div className="space-y-5">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      When and where you can deliver
                    </p>
                  </div>
                </div>
                <div className="w-0.5 h-4 bg-border ml-4"></div>
          ...
          <Card className="shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                ...
                {currentStep === 2 &&
                  "Tell us about your vehicle and delivery experience"}
                {currentStep === 3 &&
                  "Let us know when and where you can deliver"}
                {currentStep === 4 &&
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-center mb-6">
                          <div className="relative">
                            <div
                              className={`h-24 w-24 rounded-full border-2 border-dashed border-primary flex items-center justify-center ${
                                uploadedImage ? "bg-transparent" : "bg-muted"
                              }`}
                            >
                              {uploadedImage ? (
                                <img
                            ...
                            <Label
                              ...
                              className="block text-center mt-2 text-sm text-muted-foreground cursor-pointer"
                            >
                            ...
                            <FormItem>
                              ...
                              >
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="20+kg">
                                    More than 20 kg
                                  </SelectItem>
                                </SelectContent>
                              </Select>
                              <FormDescription>
                                The maximum weight of packages you are
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem className="md:col-span-2">
                                ...
                                <FormDescription>
                                  Enter comma-separated areas (e.g., Bandra,
                                  Andheri, 400001)
                                </FormDescription>
                                <FormMessage />
                              </FormItem>
                    ...
                    >
                      <div className="space-y-4">
                        <div className="rounded-md border p-4 space-y-4">
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              ...
                              <div>
                                ...
                                <p className="font-medium">
                                  {form.getValues().experience} years
                                </p>
                              </div>
                          ...
                          <div>
                            <h3 className="font-medium text-base flex items-center gap-2">
                              <Map className="h-4 w-4 text-primary" /> Service
                              Area
                            </h3>
                            <Separator className="my-2" />
                            <div className="grid grid-cols-2 gap-4 text-sm">
