...
export default function DarkstoreOwnerApplicationPage() {
  ...
  const nextStep = async () => {
    if (currentStep === 1) {
      const basicFields = ["storeName", "storeType", "address", "city", "state", "pincode"];
      ...
      const detailsFields = ["storeDescription", "operatingHours", "deliveryCapability"];
        ...
        <div className="lg:w-1/3 space-y-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Join our platform as a darkstore owner and provide quality pooja items to devotees in your area.
            </p>
          </div>
            ...
            <CardContent className="p-6">
              <div className="space-y-5">
                <div className="flex gap-2 items-center">
                  ...
                  <div>
                    <p className={`font-medium ${currentStep >= 1 ? "text-primary" : ""}`}>Basic Information</p>
                    <p className="text-xs text-muted-foreground">Store details and location</p>
                  </div>
                </div>
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <div>
                    <p className={`font-medium ${currentStep >= 2 ? "text-primary" : ""}`}>Inventory Information</p>
                    <p className="text-xs text-muted-foreground">Categories and capacity</p>
                  </div>
                </div>
                <div className="w-0.5 h-4 bg-border ml-4"></div>
                <div className="flex gap-2 items-center">
                  ...
                  <div>
                    <p className={`font-medium ${currentStep >= 3 ? "text-primary" : ""}`}>Additional Details</p>
                    <p className="text-xs text-muted-foreground">Hours and capabilities</p>
                  </div>
                </div>
                <div className="w-0.5 h-4 bg-border ml-4"></div>
                <div className="flex gap-2 items-center">
          ...
          <Card className="shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                ...
                {currentStep === 2 && "Tell us about what you can stock and sell"}
                {currentStep === 3 && "Add more information about your operations"}
                    ...
                    >
                      <div className="space-y-4">
                        <div className="flex items-center gap-2">
                          ...
                          <h3 className="font-medium text-sm">Inventory Capabilities</h3>
                        </div>
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                              ...
                              <div className="space-y-1 leading-none">
                                ...
                                <FormDescription>
                                  Do you have a dedicated storage space for maintaining inventory?
                                </FormDescription>
                              </div>
                            </FormItem>
                          )}
                              ...
                              <FormControl>
                                ...
                                >
                                  <FormItem className="flex items-center space-x-3 space-y-0">
                                    ...
                                    <FormLabel className="font-normal">We can handle our own deliveries</FormLabel>
                                  </FormItem>
                                  <FormItem className="flex items-center space-x-3 space-y-0">
                                    <FormControl>
                                      <RadioGroupItem value="platform" />
                                    </FormControl>
                                    <FormLabel className="font-normal">We need platform delivery partners</FormLabel>
                                  </FormItem>
                                  <FormItem className="flex items-center space-x-3 space-y-0">
                                    <FormControl>
                                      <RadioGroupItem value="both" />
                                    </FormControl>
                                    <FormLabel className="font-normal">We can do both depending on volume</FormLabel>
                                  </FormItem>
                                </RadioGroup>
                              </FormControl>
                              <FormMessage />
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="grid grid-cols-2 gap-4 mt-1">
                            <div className="border border-dashed rounded-lg p-4 flex flex-col items-center justify-center cursor-pointer hover:bg-muted/50 transition-colors">
                              <Label htmlFor="store-image" className="cursor-pointer text-center">
                                <Upload className="h-8 w-8 mb-2 mx-auto text-muted-foreground" />
                                <span className="text-sm font-normal text-muted-foreground">Upload Store Front</span>
                                <Input 
                                  id="store-image" 
                                  type="file" 
                                  className="hidden" 
                            ...
                            <div className="border border-dashed rounded-lg p-4 flex flex-col items-center justify-center cursor-pointer hover:bg-muted/50 transition-colors">
                              <Label htmlFor="interior-image" className="cursor-pointer text-center">
                                <Upload className="h-8 w-8 mb-2 mx-auto text-muted-foreground" />
                                <span className="text-sm font-normal text-muted-foreground">Upload Interior</span>
                                <Input 
                                  id="interior-image" 
                                  type="file" 
                                  className="hidden" 
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                              {uploadedImages.map((img, i) => (
                                <div key={i} className="relative w-20 h-20 rounded-md overflow-hidden border">
                                  <img src={img} alt={`Uploaded image ${i}`} className="w-full h-full object-cover" />
                                </div>
                              ))}
                            </div>
                          )}
                      ...
                      <div className="space-y-4">
                        <div className="rounded-md border p-4 space-y-4">
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              <div>
                                ...
                                <p className="font-medium">{form.getValues().storeName}</p>
                              </div>
                              <div>
                                <span className="text-muted-foreground">Store Type:</span>
                                <p className="font-medium">
                                  {form.getValues().storeType === 'temple-shop' && 'Temple Shop'}
                                  {form.getValues().storeType === 'retail-store' && 'Retail Store'}
                                  {form.getValues().storeType === 'warehouse' && 'Warehouse'}
                                  {form.getValues().storeType === 'home-based' && 'Home-based'}
                                  {form.getValues().storeType === 'other' && 'Other'}
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              <div>
                                <span className="text-muted-foreground">Store Size:</span>
                                <p className="font-medium">
                                  {form.getValues().storeSize === 'small' && 'Small (< 500 sq ft)'}
                                  {form.getValues().storeSize === 'medium' && 'Medium (500-1000 sq ft)'}
                                  {form.getValues().storeSize === 'large' && 'Large (1000-2000 sq ft)'}
                                  {form.getValues().storeSize === 'xl' && 'Extra Large (> 2000 sq ft)'}
                                </p>
                              </div>
                              <div>
                                <span className="text-muted-foreground">Has Storage:</span>
                                <p className="font-medium">
                            ...
                            <div className="mt-2">
                              ...
                              <div className="flex flex-wrap gap-2 mt-1">
                                {form.getValues().itemCategories.map((category) => (
                                  <Badge key={category} variant="outline">
                                    {itemCategoryOptions.find(opt => opt.id === category)?.label}
                                  </Badge>
                                ))}
                              </div>
                            </div>
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              <div>
                                ...
                                <p className="font-medium">{form.getValues().operatingHours}</p>
                              </div>
                              <div>
                                <span className="text-muted-foreground">Delivery Capability:</span>
                                <p className="font-medium">
                                  {form.getValues().deliveryCapability === 'self' && 'Self-managed'}
                                  {form.getValues().deliveryCapability === 'platform' && 'Platform delivery partners'}
                                  {form.getValues().deliveryCapability === 'both' && 'Both options'}
                                </p>
                              </div>
                            </div>
                          </div>
