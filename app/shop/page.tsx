...
const products = [
  ...
  },
  {
    ...
    description: "Complete pooja service with experienced pandit",
    price: 5999,
    image: "/placeholder.svg?height=200&width=200",
    category: "pooja",
  },
  {
    id: 8,
    name: "Griha Pravesh",
    description: "Housewarming ceremony with all required items",
    price: 7999,
    image: "/placeholder.svg?height=200&width=200",
    category: "pooja",
  },
  {
    id: 9,
    name: "Ganesh Pooja",
    description: "Ceremony to honor Lord Ganesha",
    price: 4999,
    image: "/placeholder.svg?height=200&width=200",
    category: "pooja",
  },
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={() => setActiveTab(activeTab === "samagri" ? "all" : "samagri")}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={() => setActiveTab(activeTab === "pooja" ? "all" : "pooja")}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={() => setActiveTab(activeTab === "package" ? "all" : "package")}
                      />
              ...
              {sortedProducts.map((product) => (
                <Card key={product.id} className="overflow-hidden scale-in">
                  ...
                  <CardFooter className="p-4 pt-0 flex gap-2">
                    <Button variant="default" className="w-full" onClick={() => addToCart(product.id, product.name)}>
